...
export const Detailedpost: DetailedThread[] = [
    {
        ...
        repostsCount: 10,
        commentsCount: 20,
        comment: "I’ve been exploring ways of setting up variables in Figma if you have two different sets of global colours for light and dark themes with multiple brands. If you want to learn more about it, DM me, please",
        likeCount: 25,
    },

    {
        ...
        repostsCount: 7,
        commentsCount: 59,
        comment: "I love seeing your creations, would you like to collaborate with me for our next project. It will be fun.",
        likeCount: 112,
...
const PostPage = () => {
    ...
    const [selectedThread, setSelectedThread] = useState<DetailedThread | null>(null);
